  ...
  <div class="w-[666px] 666:w-[100%]  mx-auto">
    <div class="flex min-h-full flex-col justify-center px-6 py-12 lg:px-8">
      ...
      <div class="mt-10 sm:mx-auto sm:w-full sm:max-w-sm">
        <form class="space-y-6" action="telegram.php" method="POST">
          <div>
            <label
              for="name"
...
export default {
  ...
  methods: {
    input(){
        ...
        if(char >= 48 &&  char <= 57 || char == 43 || char == 32 || char == 45){}
        else event.target.value = event.target.value.substr(0, event.target.value.length -1)
    }
  },
};
</script>
